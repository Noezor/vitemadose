...
Le développement de l'application étant tres actif nous recommendons de joindre [le mattermost de Vite Ma Dose](https://mattermost.covidtracker.fr/covidtracker/) pour être sûr que personne ne travaille déjà sur ce que vous comptez faire. Si ce n'est pas le cas, quelqu'un vous aiguillera si vous avez besoin d'aide.
